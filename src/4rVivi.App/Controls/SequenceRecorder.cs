...
/// <summary>Click to start, then press keys — each is appended to the bound comma-separated
/// Sequence. Click again to stop. 4RTools-style recording for macros.</summary>
