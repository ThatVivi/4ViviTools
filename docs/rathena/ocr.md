...
## rAthena OCR corpus refresh

Use `tools/ocr-train/fetch_rathena_corpus.py` to refresh monster, item, skill, status, class, map,
and HUD vocabularies from upstream rAthena. See [ocr-data-refresh.md](ocr-data-refresh.md) for the
exact command, generated files, counts, and recommended usage.
